...
export const PracticeHub = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background-light dark:bg-background-dark text-text-main dark:text-gray-100">
      ...
      <main className="flex-grow w-full max-w-7xl mx-auto px-6 py-10 animate-fade-in flex flex-col gap-10">
        
        <header>
            <h1 className="text-4xl font-black tracking-tight mb-2">Practice Center</h1>
        ...
        <section>
            ...
            <div 
                className="bg-gradient-to-r from-primary/90 to-primary rounded-3xl p-8 text-text-main shadow-lg relative overflow-visible group border border-yellow-400/50 hover:shadow-xl transition-all" 
            >
                {/* Background Decor */}
                ...
                <div className="relative z-10 flex flex-col gap-6 items-start max-w-2xl">
                    ...
                    <div>
                        ...
                        <h2 className="text-4xl font-black tracking-tight group-hover:translate-x-1 transition-transform cursor-default">
                            {displayTitle}
                        </h2>
                    </div>
