          ...
          >
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="flex flex-col">
                <h3 className="text-lg sm:text-xl font-black text-text-main dark:text-white tracking-tight">
                  {checkinStatus === 'checked_in' ? 'Checked In Today' : 'Daily Check-in'}
                </h3>
                <p className="text-xs sm:text-sm font-medium text-text-secondary dark:text-gray-400">
                  {checkinStatus === 'checked_in' ? "You've earned today's rewards! Come back tomorrow." : 'Maintain your streak & earn daily rewards'}
                </p>
              </div>
            </div>
