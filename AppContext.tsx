...
export const AppProvider = ({ children }: React.PropsWithChildren) => {
  ...
  const login = (email: string) => {
    ...
    // Simulate creating/fetching a profile derived from email
    ...
    setUser(prev => ({
        ...
        email: email,
        avatarUrl: `https://ui-avatars.com/api/?name=${formattedName || 'Student'}&background=f9d406&color=1c1a0d&bold=true`
    }));
  };
