          ...
          <div className="flex items-center h-full">
            ...
            {isAuthenticated && (
              <div className="ml-2 sm:ml-4 relative shrink-0" ref={notifRef}>
                ...
                {showNotifications && (
                  <div className="absolute left-0 mt-2 w-[calc(100vw-40px)] max-w-sm sm:w-80 bg-white dark:bg-surface-dark rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 overflow-hidden animate-fade-in origin-top-left z-50">
