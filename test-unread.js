...
async function run() {
  const { data, error } = await supabase.rpc('get_total_unread_count', { user_uuid: 'b0e01476-b6fb-40c2-9e95-2c8e31de3ab2' }); // Assume some uuid, wait, I can just print the definition of the function!
}
run();
