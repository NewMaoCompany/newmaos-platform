...
def main():
    input_file = 'database/limits_update_part4.json'
    output_file = 'database/update_unit1_limits_part4.sql'
    ...
    target_titles = [
        "1.9-P1", "1.9-P2", "1.9-P3", "1.9-P4", "1.9-P5",
        "1.10-P1", "1.10-P2", "1.10-P3", "1.10-P4", "1.10-P5"
    ]
    ...
    with open(output_file, 'w') as f:
        f.write("-- Update Unit 1 Limits Questions Part 4 (Chapters 1.9 & 1.10)\n")
        f.write("BEGIN;\n\n")
        ...
        for i, (q, old_title) in enumerate(zip(questions, target_titles)):
            ...
            # Sub Topic ID: "U1_1.9" -> "1.9"
            raw_sub_topic = q.get('sub_topic_id')
            if raw_sub_topic and raw_sub_topic.startswith('U1_'):
