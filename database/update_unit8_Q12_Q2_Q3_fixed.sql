...
-- Ensure all skills used in the updates exist to prevent FK violations.
...
SET
  ...
  topic_id = 'Both_AppIntegration',
  updated_at = NOW()
WHERE title = '8.0-UT-Q2';


-- 4. Update Question 3 (Unit 8)
UPDATE public.questions
SET
  course = 'Both',
  topic = 'Both_AppIntegration',
  ...
  topic_id = 'Both_AppIntegration',
  updated_at = NOW()
WHERE title = '8.0-UT-Q3';


-- 5. Sync Relation Table question_skills (For Q12, Q2, Q3)
DELETE FROM question_skills
WHERE question_id IN (
    SELECT id FROM questions WHERE title IN ('8.0-UT-Q12', '8.0-UT-Q2', '8.0-UT-Q3')
);
...
FROM questions 
WHERE title IN ('8.0-UT-Q12', '8.0-UT-Q2', '8.0-UT-Q3')
