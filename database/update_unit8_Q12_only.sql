...
INSERT INTO public.error_tags (id, name, category, severity, unit) VALUES
  ...
  ('E_WRONG_VARIABLE_DYDX', 'Wrong Variable of Integration', 'Conceptual', 4, 'Unit 8')
...
-- 3. Sync Relation Table question_skills (For Q12)
DELETE FROM question_skills
WHERE question_id IN (
    SELECT id FROM questions WHERE title = '8.0-UT-Q12'
);
