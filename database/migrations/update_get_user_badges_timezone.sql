-- ============================================================
-- FIX: get_user_badges RPC with Timezone Support
-- Accepts p_client_date so badges reset at LOCAL midnight, not UTC midnight.
-- ============================================================

DROP FUNCTION IF EXISTS public.get_user_badges(UUID);
DROP FUNCTION IF EXISTS public.get_user_badges(UUID, DATE);
