-- ============================================================
-- Migration: Fix Check-in Notification Logic v6
-- Description: Update generate_system_notifications to check specific user_checkins table
--              instead of relying solely on user_stats.last_practiced.
-- ============================================================
...
BEGIN
    ...
    -- FIXED: Now checks user_checkins table too!
    -- ============================================================
    v_prefix := '📅 Daily Check-in available!';
    
    -- Check if user has NOT practiced AND NOT checked-in today
    IF NOT v_has_practiced_today AND NOT v_has_checked_in_today THEN
        ...
        END IF;
    ELSE
        -- If they HAVE practiced OR checked-in, clear ALL reminders
