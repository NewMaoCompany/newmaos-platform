-- ============================================================
-- Fix Check-in Timezone Mismatch
-- 
-- Problem: UTC CURRENT_DATE was used, causing "tomorrow" to be 
--          checked in after 7 PM EST.
-- Fix: Accept p_client_date from the frontend to ensure 
--      consistency with the user's local day.
-- ============================================================

-- 1. Updated RPC: perform_daily_checkin
...
-- 2. Updated RPC: get_checkin_status
...
-- 3. Updated RPC: record_login_streak
