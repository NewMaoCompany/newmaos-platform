-- Unit 10 Full Restoration Script
-- This script cleans all existing Unit 10 questions and re-seeds them from the authoritative source.
-- Goal: Restore 'questions' table to 755 rows.

BEGIN;

-- 1. Relax status constraint to allow 'published'
DO $$ 
BEGIN 
...
-- 2. Ensure Skills and Error Tags exist (UPSERT)
DO $$
BEGIN
    -- Skills
    INSERT INTO public.skills (id, name, unit) VALUES
        ...
        ('series_convergence_divergence_basic', 'Basic Series Convergence/Divergence', 'Unit10_InfiniteSequencesAndSeries'),
    ...
    INSERT INTO public.error_tags (id, name, category, severity, unit) VALUES
        ...
        ('strategy_test_choice_wrong', 'Chose Inefficient/Wrong Test', 'Strategy', 2, 'Unit10_InfiniteSequencesAndSeries'),
        ...
        ('\\interval_notation_error', 'Interval Notation Error (Open/Closed)', 'Notation', 2, 'Unit10_InfiniteSequencesAndSeries'),
        ('endpoint_open_closed_confusion', 'Confused Open/Closed Endpoints', 'Conceptual', 2, 'Unit10_InfiniteSequencesAndSeries'),
    ...
    -- 3. CLEANUP everything in BC_Series before restoration
    DELETE FROM public.questions WHERE topic_id = 'BC_Series';

END $$;

-- 4. INSERT 95 QUESTIONS
-- (Extracted and optimized from insert_unit10_questions.sql)
    -- 4. Insert Questions
