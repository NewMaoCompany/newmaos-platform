...
export const TEXTBOOK_DATA: Record<'AB' | 'BC', TextbookInfo[]> = {
  AB: [
    ...
    { unitId: 'Both_Applications', unitNumber: 4, title: 'Contextual Applications', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_4.pdf', available: true, downloadCost: 19, pageCount: 26, coverColor: '#ef4444', icon: 'speed' },
    { unitId: 'Both_Analytical', unitNumber: 5, title: 'Analytical Applications', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_5.pdf', available: true, downloadCost: 19, pageCount: 30, coverColor: '#8b5cf6', icon: 'insights' },
    { unitId: 'Both_Integration', unitNumber: 6, title: 'Integration & Accumulation', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_6.pdf', available: true, downloadCost: 19, pageCount: 28, coverColor: '#06b6d4', icon: 'waterfall_chart' },
    { unitId: 'Both_DiffEq', unitNumber: 7, title: 'Differential Equations', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_7.pdf', available: true, downloadCost: 19, pageCount: 20, coverColor: '#ec4899', icon: 'wind_power' },
    { unitId: 'Both_AppIntegration', unitNumber: 8, title: 'Applications of Integration', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_8.pdf', available: true, downloadCost: 19, pageCount: 26, coverColor: '#f97316', icon: 'view_in_ar' },
  ],
  BC: [
    { unitId: 'Both_Limits', unitNumber: 1, title: 'Limits and Continuity', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_1.pdf', available: true, downloadCost: 19, pageCount: 24, coverColor: '#6366f1', icon: 'waves' },
    { unitId: 'Both_Derivatives', unitNumber: 2, title: 'Differentiation: Definition', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_2.pdf', available: true, downloadCost: 19, pageCount: 28, coverColor: '#f59e0b', icon: 'trending_up' },
    ...
    { unitId: 'Both_DiffEq', unitNumber: 7, title: 'Differential Equations', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_7.pdf', available: true, downloadCost: 19, pageCount: 20, coverColor: '#ec4899', icon: 'wind_power' },
    { unitId: 'Both_AppIntegration', unitNumber: 8, title: 'Applications of Integration', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_8.pdf', available: true, downloadCost: 19, pageCount: 26, coverColor: '#f97316', icon: 'view_in_ar' },
    { unitId: 'BC_Unit9', unitNumber: 9, title: 'Parametric, Polar & Vector', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_9.pdf', available: true, downloadCost: 19, pageCount: 28, coverColor: '#14b8a6', icon: 'radar' },
    { unitId: 'BC_Series', unitNumber: 10, title: 'Infinite Sequences & Series', subtitle: 'Review Book', pdfUrl: '/books/BC_Unit_10.pdf', available: true, downloadCost: 19, pageCount: 32, coverColor: '#a855f7', icon: 'all_inclusive' },
  ]
};